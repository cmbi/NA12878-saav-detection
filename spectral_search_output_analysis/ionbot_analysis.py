...
def plot_mut(mutant_cpdtpep,counterpart_cpdtpep,cpdtpep,fullseqs,figname):
    ...
    sns.regplot(*zip(*mut_pep_abundance),scatter=True,fit_reg=True, color='r',label='Variant peptide',alpha=1)
    sns.regplot(*zip(*nonmut_pep_abundance),scatter=True,fit_reg=True,color='b',label='Normal peptide',alpha=0.25)
